...
But it integrates deeply with Kore 3 (see https://github.com/Kode/Kore) and making it usable with anything else requires some code to be written (see https://github.com/Kode/Kongruent/tree/main/sources/integrations).
...
Samples can be found at https://github.com/Kode/Kore-Samples.
